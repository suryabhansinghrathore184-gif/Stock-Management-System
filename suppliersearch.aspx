<%@ Page Title="Search Supplier" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="suppliersearch.aspx.cs" Inherits="StockMangementSystem.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid p-0">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h3 class="fw-bold mb-0 text-dark">Find Supplier Profile</h3>
            ...
            <div class="col-lg-8">
                ...
                <div class="card card-premium mb-4">
                    <div class="card-body">
                        <div class="row align-items-end g-3">
                            <div class="col-md-8">
                                <label class="form-label fw-bold text-muted">Enter Supplier ID <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 d-flex gap-2">
                                ...
                                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Delete" CssClass="btn btn-outline-danger btn-lg w-100" 
                                    OnClientClick="return confirm('Are you sure you want to permanently delete this supplier?');" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-premium">
                    <div class="card-header bg-white border-0 pt-4 pb-0">
                        <h5 class="fw-bold m-0"><i class="fa-solid fa-address-card me-2 text-primary"></i>Supplier Record Details</h5>
                    </div>
                    <div class="card-body text-center text-md-start">
                        <div class="row align-items-center mb-4">
                            ...
                            <div class="col-md-9">
                                <h4 class="fw-bold text-dark mb-1"><asp:Label ID="Label2" runat="server" Text="-"></asp:Label></h4>
                                <span class="text-muted fw-semibold d-block mb-1"><i class="fa-solid fa-building me-1.5 text-primary"></i><asp:Label ID="Label3" runat="server" Text="Acme Corp"></asp:Label></span>
                                <span class="badge bg-success rounded-pill px-3 py-1.5"><asp:Label ID="Label11" runat="server" Text="Active"></asp:Label></span>
                            </div>
                        </div>
